...
import { deleteReview, getAllReviews, updateReviewStatus, replyToReview } from "../controllers/reviewController.js";
...
adminRouter.put("/reply/:id", verifyToken, verifyAdmin, replyToReview);
